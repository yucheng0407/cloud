...
public class JT809Constants {
    ...
    public static int UP_CONNECT_REQ = 0x1001;//主链路登录请求消息 4097
    public static int UP_CONNECT_RSP = 0x1002;//主链路登录应答消息 4098
    ...
    public static int DOWN_LINKETEST_REQ = 0x9005;//从链路连接保持请求消息
    public static int DOWN_LINKETEST_RSP = 0x9006;//从链路连接保持应答消息
    ...
    public static int DOWN_BASE_MSG = 0x9600;//从链路静态信息交换消息
